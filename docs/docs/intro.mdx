...
:::info
The shared config includes `eslint-plugin-tmdr-nuxt` plus a curated set of other ESLint plugins. See the [ESLint Config](./eslint-config) page for full details.
:::
